...
public class SaccountImpl implements SaccountService{
	...
	private final String bankCode = "4799";
	private final String countryCode = "91";
	private final String branchCode = "999";
	...
	public DepositResponse deposit(long acc, int amount) {
		...
		try {
			...
			dao.save(account);
			response.setResponseMessage("Rs."+amount+" successfully deposited into your account and your balance is now Rs."+account.getBalance());
	...
	public WithdrawResponse withdraw(long acc, int amount) {
		...
		try {
			...
			if(account.getBalance()>=amount) 
				...
				dao.save(account);
				response.setResponseMessage("Rs."+amount+" successfully withdrawn from your account and your balance is now Rs."+account.getBalance());
